...
import com.exemple.algamoney.api.exceptionhandler.AlgamoneyExceptionHandler;
...
public class LancamentoResource {
    ...
    @GetMapping(params = "resumo") // se tiver o parametro resumo ele vai chamar esse metodo
    @PreAuthorize("hasAuthority('ROLE_PESQUISAR_LANCAMENTO')and #Oauth2.hasScope('read')")
